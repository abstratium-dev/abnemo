...
```bash
# System packages
sudo apt install python3-scapy python3-dnspython python3-tabulate python3-flask python3-flask-wtf python3-watchdog python3-cryptography python3-jwt python3-debugpy
```
